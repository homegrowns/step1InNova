...
public class ItemMoveCallback extends ItemTouchHelper.Callback {
    ...
    @Override public int getMovementFlags(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder)
    {
        //이벤트의 방향 설정
        // 아이템 좌우 배치
        int flagDrag1 = ItemTouchHelper.START | ItemTouchHelper.END| ItemTouchHelper.UP | ItemTouchHelper.DOWN;
        //item drag
//        int flagSwipe = ItemTouchHelper.UP | ItemTouchHelper.DOWN;
        //item swipe

        // 아이템 상하 배치 /*
        int flagDrag2 = ItemTouchHelper.UP | ItemTouchHelper.DOWN; //item drag
        int flagSwipe = ItemTouchHelper.START | ItemTouchHelper.END;//item swipe */

         return makeMovementFlags(flagDrag1,0);// drag & swipe 사용
//        return makeMovementFlags(flagDrag2, 0); //swipe 액션 중지
