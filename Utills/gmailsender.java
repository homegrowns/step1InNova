...
//        props.setProperty("mail.smtp.quitwait", "false");
    ...
    private String createEmailCode()
    {
        ...
        for (int x = 0; x < 8; x++)
        {
            int random = (int) (Math.random() * str.length); newCode += str[random];
        }
        return newCode;
    }
